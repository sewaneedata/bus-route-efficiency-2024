...
ui <- page_navbar(
  ...
  tabsetPanel(
    tabPanel(h4("Home Page"),
             ...
             fluidRow(
               column(12,
                      tags$img(src = 'Logos.png', width = "75%", alt = "Picture of Datalab & Franklin County Logo", align = "center"
                      ),
               )
               ),
             ...
             tabPanel(h4('Partners', class = "body"),
                      ...
                      fluidRow(
                        ...
                        column(
                          ...
                          fluidRow(
                            p("BreAsia Calhoun C'26, University of the South", align = "center")
                          )
                        ),
                        column(
                          2,
                          ...
                          fluidRow(
                            p("Mason Dickens C'26, University of the South", align = "center")
                          )
                        ),
                        column(
                          2,
                          ...
                          fluidRow(
                            p("Shiraz Robinson II C'23, University of Maryland", align = "center")
                          )
                        ),
                        column(
                          2,
                          ...
                          fluidRow(
                            p("Srijan Basnet C'27, University of the South", align = "center")
                          )
                        ),
                        column(
                          2,
                          ...
                          fluidRow(
                            p("Tuyen Le C'24, University of the South", align = "center")
                          )
                        ),
                        column(1)
                      ),
